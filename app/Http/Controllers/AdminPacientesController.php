<?php namespace App\Http\Controllers;
	...
	class AdminPacientesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Data de nascimento","name"=>"nascimento"];
			$this->col[] = ["label"=>"Idade Atual","name"=>"idadeAtual"];
			...
			$this->col[] = ["label"=>"UF","name"=>"uf"];
			$this->col[] = ["label"=>"CEP","name"=>"cep"];
			$this->col[] = ["label"=>"Profissão","name"=>"profissao"];
			$this->col[] = ["label"=>"Renda","name"=>"renda"];
			$this->col[] = ["label"=>"Apresenta alguma necessidade especial?","name"=>"possuiNecessEspecial"];
			$this->col[] = ["label"=>"Se sim, qual?","name"=>"qualNecessEspecial"];
			$this->col[] = ["label"=>"Participa de algum programa social? (Ex: COMPP/CREAS)","name"=>"participaProgSocial"];
			$this->col[] = ["label"=>"Se sim, Qual(is)?","name"=>"qualProgSocial"];
			$this->col[] = ["label"=>"Telefone residencial","name"=>"telResidencial"];
			$this->col[] = ["label"=>"Telefone trabalho","name"=>"telTrabalho"];
			$this->col[] = ["label"=>"Telefone celular","name"=>"telCelular"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Nome','name'=>'nome','type'=>'wysiwyg','validation'=>'required','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'CEP','name'=>'cep','type'=>'googlemaps','width'=>'col-sm-10'];
