<?php namespace App\Http\Controllers;
	...
	class AdminProntuariosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Terapeutas Id","name"=>"terapeutas_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"terapeutas,id"];
			//$this->form[] = ["label"=>"Coordenadores Id","name"=>"coordenadores_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"coordenadores,id"];
			...
			//$this->form[] = ["label"=>"DataAtendimento","name"=>"dataAtendimento","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"HorarioAtendimento","name"=>"horarioAtendimento","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
			//$this->form[] = ["label"=>"NumeroAtendimento","name"=>"numeroAtendimento","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Data","name"=>"data","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"TipoAtendimento","name"=>"tipoAtendimento","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"DescricaoAtendimento","name"=>"descricaoAtendimento","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
